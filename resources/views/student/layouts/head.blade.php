<head>
    ...
    <title>{{ config('app.name', 'FSAAM') }} - @yield('title', 'Dashboard')</title>
    ...
    <meta name="twitter:title" content="FSAAM Student Portal">
    <meta name="twitter:description" content="Student portal for FSAAM university">
    <meta property="og:title" content="FSAAM Student Portal">
    <meta property="og:description" content="Student portal for FSAAM university">
