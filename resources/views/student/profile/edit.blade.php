...
<div
    class="relative overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-800 dark:to-gray-900 border border-gray-200 dark:border-gray-700 rounded-3xl mb-8 shadow-lg">
    <div
        class="absolute inset-0 bg-gradient-to-r from-blue-600/5 to-purple-600/5 dark:from-blue-400/5 dark:to-purple-400/5">
    </div>
    <div class="relative p-8">
                ...
                <div class="flex flex-col items-center w-full gap-8 xl:flex-row">
                    ...
                    <div class="relative group">
                        <div class="relative w-40 h-40">
                            <!-- Animated border -->
                            <div
                                class="absolute inset-0 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-2xl p-1 animate-pulse">
                                <div class="w-full h-full bg-white dark:bg-gray-800 rounded-2xl overflow-hidden">
                                    <img id="profilePreview" src="{{ $student->setAvatar() }}"
                                        alt="Profile picture of {{ $student->full_name }}"
                            ...
                            <div class="absolute -bottom-2 -right-2">
                                <label for="avatar"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="w-6 h-6 transition-transform group-hover:scale-110" fill="none"
                                ...
                                <!-- Enhanced Tooltip -->
                                <div
                                    class="absolute -top-12 left-1/2 transform -translate-x-1/2 px-3 py-1 text-xs font-medium text-white bg-gray-900 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap">
                                    Change photo
                                    <div
                        ...
                        <div class="flex flex-col items-center gap-2 xl:flex-row xl:gap-4">
                            <div class="flex items-center gap-2 px-3 py-1 bg-blue-100 dark:bg-blue-900/30 rounded-full">
                                <svg class="w-4 h-4 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-4 0v1a2 2 0 104 0">
                                    </path>
                                </svg>
                                <span class="text-sm font-medium text-blue-700 dark:text-blue-300">{{ $student->cne
                                    }}</span>
                            </div>
                            <div
        ...
        @if (!$student->avatar)
        <div class="flex items-start gap-3 p-4 mt-6 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl"
            role="alert">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-amber-700 dark:text-amber-300">Please upload your profile photo to complete
                    your registration.</p>
            </div>
        </div>
        @endif
        ...
        <div
            class="flex items-start gap-3 p-4 mt-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl">
            <div class="flex-shrink-0">
    ...
    <div class="p-8">
        <form action="{{ route('student.profile.update') }}" method="POST">
            ...
            <div class="mb-8">
                ...
                <div
                    class="flex items-start gap-2 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl">
                    ...
                    <p class="text-sm text-red-700 dark:text-red-300">
                        <span class="font-semibold">Important:</span> Please fill in missing information and contact
                        administration immediately if there are any mistakes.
                    </p>
                </div>
            </div>
            ...
            <div x-data="{ tab: 'personal' }">
                <div class="mb-8">
                    <nav class="flex space-x-1 bg-gray-100 dark:bg-gray-700 p-1 rounded-xl" aria-label="Profile tabs">
                        <button type="button"
                            ...
                            @click="tab = 'personal'" :aria-selected="tab === 'personal'">
                        ...
                        <button type="button"
                            ...
                            @click="tab = 'contact'" :aria-selected="tab === 'contact'">
                            <span class="flex items-center justify-center gap-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <button type="button"
                            ...
                            @click="tab = 'additional'" :aria-selected="tab === 'additional'">
                            <span class="flex items-center justify-center gap-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div x-show="tab === 'personal'" x-transition:enter="transition ease-out duration-200"
                    ...
                    x-transition:enter-end="opacity-100 transform translate-y-0" class="space-y-8">
                    <div class="grid lg:grid-cols-2 gap-8">
                        <div class="space-y-6">
                            <x-input-field label="First Name" name="prenom" value="{{ $student->prenom }}"
                                placeholder="John" icon="user" />
                            <x-input-field label="Last Name" name="nom" value="{{ $student->nom }}" placeholder="Doe"
                                icon="user-group" />
                            <x-input-field label="الإسم الشخصي" name="prenom_ar" value="{{ $student->prenom_ar }}"
                                placeholder="محمد" icon="language" />
                            <x-input-field label="الإسم العائلي" name="nom_ar" value="{{ $student->nom_ar }}"
                                placeholder="العلوي" icon="language" />
                        </div>
                        <div class="space-y-6">
                            <x-input-field label="CIN" name="cin" value="{{ $student->cin }}" placeholder="AB123456"
                                icon="identification" />
                            <x-input-field label="CNE" name="cne" value="{{ $student->cne }}" placeholder="P123456789"
                                icon="academic-cap" />
                            <x-input-field type="date" label="Date of Birth" name="date_naissance"
                                value="{{ $student->date_naissance ? \Carbon\Carbon::parse($student->date_naissance)->format('Y-m-d') : '' }}"
                                icon="calendar" />
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select name="sexe" id="sexe"
                                        class="block w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                                ...
                                <div>
                                    <label for="nationalite"
                                        class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Nationality</label>
                                    <select name="nationalite" id="nationalite"
                                        class="block w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                                        <option value="">Select Nationality</option>
                                        <option value="MA" {{ $student->nationalite === 'MA' ? 'selected' : ''
                                            }}>Moroccan</option>
                                        <option value="ET" {{ $student->nationalite === 'ET' ? 'selected' : ''
                                            }}>Foreign</option>
                                    </select>
                                    @error('nationalite')
                ...
                <!-- Contact Tab -->
                <div x-show="tab === 'contact'" x-transition:enter="transition ease-out duration-200"
                    x-transition:enter-start="opacity-0 transform translate-y-4"
                    x-transition:enter-end="opacity-100 transform translate-y-0" class="space-y-8">
                    <div class="grid lg:grid-cols-2 gap-8">
                        <div class="space-y-6">
                            <x-input-field label="Phone" name="tel" value="{{ $student->tel }}"
                                placeholder="+212 600 000 000" icon="phone" />
                            <x-input-field label="Emergency Phone" name="tel_urgence"
                                value="{{ $student->tel_urgence }}" placeholder="+212 600 000 000" icon="phone" />
                        </div>
                        <div class="space-y-6">
                            <x-input-field label="Address" name="adresse" value="{{ $student->adresse }}"
                                placeholder="123 Main Street" icon="location-marker" />
                            <x-input-field label="العنوان" name="adresse_ar" value="{{ $student->adresse_ar }}"
                                placeholder="شارع 123 الرئيسي" icon="translate" />
                        </div>
                    </div>
                </div>

                <!-- Additional Tab -->
                <div x-show="tab === 'additional'" x-transition:enter="transition ease-out duration-200"
                    x-transition:enter-start="opacity-0 transform translate-y-4"
                    x-transition:enter-end="opacity-100 transform translate-y-0" class="space-y-8">
                    <div class="grid lg:grid-cols-2 gap-8">
                        <div class="space-y-6">
                            <x-input-field label="Place of Birth" name="lieu_naissance"
                                value="{{ $student->lieu_naissance }}" placeholder="Casablanca" icon="map" />
                            <x-input-field label="مكان الإزدياد" name="lieu_naissance_ar"
                                value="{{ $student->lieu_naissance_ar }}" placeholder="الدار البيضاء"
                                icon="translate" />
                        </div>
                        <div class="space-y-6">
                            <x-input-field label="Marital Status" name="situation_familiale"
                                value="{{ $student->situation_familiale }}" placeholder="Single/Married/..."
                                icon="heart" />
                            <x-input-field label="Province of Birth" name="province_naissance"
                                value="{{ $student->province_naissance }}" placeholder="Casablanca-Settat"
    ...
    <div class="py-8 bg-gray-50 dark:bg-gray-900">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div
                ...
                <div class="relative p-8">
                    <form id="profileForm" action="{{ route('profile.update.photo') }}" method="POST"
                        ...
                        <div class="mb-6">
                            ...
                            <p class="text-gray-600 dark:text-gray-400">Upload a professional photo to complete your profile
                            </p>
                        </div>
                        ...
                        <div class="flex flex-col gap-8 xl:flex-row xl:items-center xl:justify-between">
                                ...
                                <div class="relative group">
                                    <div class="relative w-40 h-40">
                                        ...
                                        <div
                                            class="absolute inset-0 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-2xl p-1 animate-pulse">
                                            <div
                                                class="w-full h-full bg-white dark:bg-gray-800 rounded-2xl overflow-hidden">
                                                <img id="profilePreview" src="{{ $student->setAvatar() }}"
                                                    alt="Profile picture of {{ $student->full_name }}"
                                                    class="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105">
                                            </div>
                                ...
                                <div class="text-center xl:text-left">
                                    ...
                                    <div class="flex flex-col items-center gap-2 xl:flex-row xl:gap-4">
                                        <div
                                            ...
                                            <span
                                                class="text-sm font-medium text-blue-700 dark:text-blue-300">{{ $student->cne }}</span>
                                        </div>
                                        <div
                                            class="flex items-center gap-2 px-3 py-1 bg-green-100 dark:bg-green-900/30 rounded-full">
                                            <svg class="w-4 h-4 text-green-600 dark:text-green-400" fill="none"
                                            ...
                                            <span
                                                class="text-sm font-medium text-green-700 dark:text-green-300">{{ $student->filiere }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex justify-center xl:justify-end">
                                <button id="uploadBtn" type="submit"
                                    class="inline-flex items-center gap-2 px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg shadow-sm hover:shadow-md transition-all duration-200 whitespace-nowrap">
                    ...
                    @if (! $student->avatar)
                        <div class="flex items-start gap-3 p-4 mt-6 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl"
                            ...
                            <div>
                                <h4 class="font-semibold text-amber-800 dark:text-amber-200">Photo Required</h4>
                                <p class="mt-1 text-sm text-amber-700 dark:text-amber-300">Please upload your profile photo to
            ...
            <div
                ...
                <form action="{{ route('student.profile.update') }}" method="POST">
                    ...
                    <div class="px-6 py-5 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Update your personal information and
                            contact details</p>
                    ...
                    <div x-data="{ tab: 'personal' }" class="p-6">
                        ...
                        <div x-show="tab === 'personal'" x-transition:enter="transition ease-out duration-200"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label for="prenom_ar"
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2" dir="rtl">
                                        الإسم الشخصي
                                    </label>
                                    <input type="text" id="prenom_ar" name="prenom_ar"
                                        value="{{ old('prenom_ar', $student->prenom_ar) }}" dir="rtl"
                                        class="block w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors">
                                    @error('prenom_ar')
                                        <p class="mt-1.5 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="text" id="nom_ar" name="nom_ar"
                                        value="{{ old('nom_ar', $student->nom_ar) }}" dir="rtl"
                                        class="block w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors">
                                    @error('nom_ar')
                                        <p class="mt-1.5 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <select id="sexe" name="sexe"
                                        ...
                                        <option value="M" {{ old('sexe', $student->sexe) === 'M' ? 'selected' : '' }}>Male
                                        </option>
                                        <option value="F" {{ old('sexe', $student->sexe) === 'F' ? 'selected' : '' }}>Female
                                        </option>
                                    </select>
                                    @error('sexe')
                                        <p class="mt-1.5 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="nationalite" name="nationalite"
                                        value="{{ old('nationalite', $student->nationalite) }}" placeholder="MA"
                                        maxlength="5"
                                        class="block w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors">
                                    @error('nationalite')
                                        <p class="mt-1.5 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="lieu_naissance_ar" name="lieu_naissance_ar"
                                        value="{{ old('lieu_naissance_ar', $student->lieu_naissance_ar) }}" dir="rtl"
                                        class="block w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors">
                                ...
                                <div>
                                    ...
                                    <select id="situation_familiale" name="situation_familiale"
                                        ...
                                        <option value="Célibataire" {{ old('situation_familiale', $student->situation_familiale) === 'Célibataire' ? 'selected' : '' }}>Single
                                        </option>
                                        <option value="Marié" {{ old('situation_familiale', $student->situation_familiale) === 'Marié' ? 'selected' : '' }}>Married</option>
                                        <option value="Divorcé" {{ old('situation_familiale', $student->situation_familiale) === 'Divorcé' ? 'selected' : '' }}>Divorced
                                        </option>
                                ...
                                <div>
                                    ...
                                    <select id="situation_professionnelle" name="situation_professionnelle"
                                        class="block w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors">
                                        <option value="">Select Status</option>
                                        <option value="Étudiant" {{ old('situation_professionnelle', $student->situation_professionnelle) === 'Étudiant' ? 'selected' : '' }}>Student
                                        </option>
                                        <option value="Salarié" {{ old('situation_professionnelle', $student->situation_professionnelle) === 'Salarié' ? 'selected' : '' }}>Employed
                                        </option>
                                        <option value="Chômeur" {{ old('situation_professionnelle', $student->situation_professionnelle) === 'Chômeur' ? 'selected' : '' }}>Unemployed
                                        </option>
                                        <option value="Autre" {{ old('situation_professionnelle', $student->situation_professionnelle) === 'Autre' ? 'selected' : '' }}>Other
                                        </option>
                                    </select>
                        ...
                        <div x-show="tab === 'contact'" x-transition:enter="transition ease-out duration-200"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <!-- Emergency Phone -->
                                <div>
                                    <label for="tel_urgence"
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                        Emergency Contact
                                    </label>
                                    <input type="tel" id="tel_urgence" name="tel_urgence"
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea id="adresse" name="adresse" rows="3" placeholder="Enter your full address"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="pays" name="pays" value="{{ old('pays', $student->pays) }}"
                                        maxlength="20"
                                        class="block w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors">
                                    @error('pays')
                                        <p class="mt-1.5 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        ...
                        <!-- Form Actions -->
                        <div
                            class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700 flex items-center justify-between gap-4">
                            <a href="
